...
TH1D* lumiHist4 = new TH1D("lumihist4","Lumi Section", nLumi, 0, nLumi);
  ...
  vz0Dist->SetAxisRange(-1.0,1.0,"X");
...
*/
  ...
  vz2Dist->Draw("same");
    ...
    TLegend *leg0 = new TLegend(0.43,0.35,0.68,0.555);
    leg0->SetFillColor(10);
    leg0->SetBorderSize(0.035);
    leg0->SetTextFont(42);
    leg0->SetTextSize(0.048);
    leg0->AddEntry(vz0Dist,"vertexz[0]","pl");
    leg0->AddEntry(vz1Dist,"vertexz[1]","pl");
    leg0->AddEntry(vz2Dist,"vertexz[2]","pl");
    leg0->Draw();

    TLatex *tex1= new TLatex(-6.,vz0Dist->GetMaximum()*0.85,"Fill = 4643, run = 262274");
  ...
  //cd->SaveAs("vz0Dist.png");
  cd->SaveAs("vz0Dist_m1p1.png");
